...
public class de extends ApplicationFrame 
{
	public de(String s) 
	{
		super(s);
	...
	private static JFreeChart createChart(TableXYDataset tablexydataset) 
	{
		JFreeChart jfreechart = ChartFactory.createStackedXYAreaChart(
				"Stacked XY Area Chart Demo 2", "X Value", "Y Value",
				tablexydataset, PlotOrientation.VERTICAL, true, true, false);
	...
	{
		de stackedxyareachartdemo2 = new de("Stacked XY Area Chart Demo 2");
